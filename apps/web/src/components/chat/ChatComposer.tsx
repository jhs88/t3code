...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  const composerProviderControls = useMemo(() => {
    const capabilities = resolveProviderComposerCapabilities(selectedProviderStatus);
    return {
      ...capabilities,
      showInteractionModeToggle: planModeUiEnabled && capabilities.showInteractionModeToggle,
    };
  }, [planModeUiEnabled, selectedProviderStatus]);
  useEffect(() => {
