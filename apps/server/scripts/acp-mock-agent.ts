...
const failAuth = process.env.T3_ACP_FAIL_AUTH === "1";
const emptyConfigOptions = process.env.T3_ACP_EMPTY_CONFIG_OPTIONS === "1";
  ...
  yield* agent.handleInitialize((request) =>
    Effect.sync(() => {
      ...
      return {
        ...
        agentInfo: { name: "t3-acp-mock-agent", version: "0.0.0-test" },
      };
    }),
  );
